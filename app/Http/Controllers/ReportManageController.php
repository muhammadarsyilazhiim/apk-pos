...
class ReportManageController extends Controller
{
    ...
    public function reportTransaction()
    {
        ...
        if($check_access->kelola_laporan == 1){
            ...
            // $totalHargaBeli = Transaction::select('kode_transaksi', DB::raw('SUM(harga_beli) as total_harga_beli'))
        	...
        	return view('report.report_transaction', compact('dates', 'incomes', 'market'));
        }else{
            return back();
        }
    }
    ...
    public function reportWorker()
    {
        ...
        if($check_access->kelola_laporan == 1){
            ...
            return view('report.report_worker', compact('users', 'market'));
        }else{
            return back();
        }
    }
    ...
    public function detailWorker($id)
    {
        ...
        if($check_access->kelola_laporan == 1){
            ...
            return view('report.detail_report_worker', compact('worker', 'dates_1', 'dates_2', 'market'));
        }else{
            return back();
        }
    }
