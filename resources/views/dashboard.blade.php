              ...
              <div class="col-12">
                <div class="form-group row">
                  ...
                  <div class="col-lg-9 col-md-9 col-sm-8 col-12">
                    <input type="text" class="form-control" name="nama_toko" placeholder="Masukkan Nama Toko" maxlength="15" value="{{ $market->nama_toko }}">
                  </div>
                ...
                <div class="form-group row">
                  <label class="col-lg-3 col-md-3 col-sm-4 col-12 col-form-label font-weight-bold">Link</label>
                  <div class="col-lg-9 col-md-9 col-sm-8 col-12">
                    <input type="text" class="form-control" name="link" placeholder="Masukkan Link Toko" value="{{ $market->link }}">
                  </div>
                </div>
              </div>
            </div>
...
<div class="row"> 
  <div class="col-lg-6 col-md-6 col-sm-12 col-12">
    <div class="row col-sm-9 mb-2"> 
        <div class="col-sm-4">
          <button id="pemasukanButton" class="btn btn-outline-primary">Pemasukan</button>
        </div>
        <div class="col-sm-4">
          <button id="keuntunganButton" class="btn btn-outline-primary">Keuntungan</button>
        </div>    
    </div>    
    <div class="row">
      <div class="col-lg-6 col-md-12 col-sm-6 col-12 mb-4 pemasukan">
      ...
      <div class="col-lg-6 col-md-12 col-sm-6 col-12 mb-4 pemasukan">
        <div class="card b-radius card-noborder">
          <div class="card-body custom-card-p">
            <div class="row">
              <div class="col-12 d-flex justify-content-start align-items-center icon-card">
                <div class="icon-round-2"><i class="mdi mdi-account-multiple"></i></div>
                <div class="ml-3">
      ...
      <div class="col-lg-6 col-md-12 col-sm-6 col-12 mb-4 keuntungan" style="display: none;">
        <div class="card b-radius card-noborder" style="background-color: #2aeb19">
          <div class="card-body custom-card-p">
            <div class="row">
              <div class="col-12 d-flex justify-content-start align-items-center icon-card">
                <div class="icon-round-3 text-white">Rp</div>
                <div class="ml-2">
                  <p class="m-0 text-white">Keuntungan Harian</p>
                  <h5 class="text-white">{{ number_format($keuntungan_harian,2,',','.') }}</h5>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="card-body custom-card-p">
            <div class="row">
              <div class="col-12 d-flex justify-content-start align-items-center icon-card">
                <div class="icon-round-3 text-white">Rp</div>
                <div class="ml-2">
                  <p class="m-0 text-white">Keuntungan Bulanan</p>
                  <h5 class="text-white">{{ number_format($keuntungan_bulanan,2,',','.') }}</h5>
                </div>
              </div>
            </div>
          </div>
  ...
  <div class="col-lg-6 col-md-6 col-sm-12 col-12">
    <div class="card b-radius card-noborder">
      <div class="card-body">
        <div class="row">
          <div class="col-12 text-center pemasukan">
          ...
          <div class="col-12 text-center keuntungan" style="display: none;">
            <p class="m-0">Total Keuntungan</p>
            <h2 class="font-weight-bold">Rp. {{ number_format($all_keuntungan,2,',','.') }}</h2>
            <p class="m-0 txt-light">{{ date('d M, Y', strtotime($min_date)) }} - {{ date('d M, Y', strtotime($max_date)) }}</p>
          </div>
...
<script>
  document.getElementById('pemasukanButton').addEventListener('click', function() {
    var pemasukanElements = document.querySelectorAll('.pemasukan');
    var keuntunganElements = document.querySelectorAll('.keuntungan');
    var pemasukanButton = document.getElementById('pemasukanButton');
    var keuntunganButton = document.getElementById('keuntunganButton');
  
    pemasukanElements.forEach(function(element) {
      element.style.display = 'block';
    });
    keuntunganElements.forEach(function(element) {
      element.style.display = 'none';
    });
  
    pemasukanButton.classList.add('active');
    keuntunganButton.classList.remove('active');
  });
  
  document.getElementById('keuntunganButton').addEventListener('click', function() {
    var pemasukanElements = document.querySelectorAll('.pemasukan');
    var keuntunganElements = document.querySelectorAll('.keuntungan');
    var pemasukanButton = document.getElementById('pemasukanButton');
    var keuntunganButton = document.getElementById('keuntunganButton');
    ...
    pemasukanButton.classList.remove('active');
    keuntunganButton.classList.add('active');
  });
  </script>
