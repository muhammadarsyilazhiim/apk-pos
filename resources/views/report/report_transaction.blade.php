            ...
            <div class="row">
              <div class="col-12">
                <div class="form-group row">
                  ...
                  <div class="col-10 border rounded-right offset-col-1">
                    <div class="form-radio">
                      <label class="form-check-label">
                        <input type="radio" class="form-check-input" name="jns_laporan" value="manual" checked> Manual</label>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div class="row">
          <div class="col-12 mb-2">
            ...
            <ul class="list-date">
              ...
              $transactions = \App\Transaction::select('kode_transaksi', \DB::raw('SUM(total_harga_beli) as total_harga_beli'))
                ->whereDate('transactions.created_at', $date)
              ...
              <div class="table-responsive">
                <table class="table table-custom">
                  ...
                  <tr>
                    @php
                    $transaksi = \App\Transaction::with('customer')->where('kode_transaksi', $transaction->kode_transaksi)
                    ->select('transactions.*')
                    ->first();
                    ...
                    <td class="text-success font-weight-bold">Rp. {{ number_format($transaction->total_harga_beli) }}</td>
                    <td>Rp. {{ number_format($transaksi->total - $transaction->total_harga_beli) }}</td>
                    <td>
                    ...
                    <td colspan="5" class="dropdown-content">
                      ...
                      <table class="table">
                        ...
                        <tr>
                          ...
                          <td>
                            <span class="light-td mb-1">Harga Jual</span>
                            <span class="bold-td">Rp. {{ number_format($product->harga) }}</span>
                          </td>
                          <td>
                            <span class="light-td mb-1">Harga Beli</span>
                            <span class="bold-td">Rp. {{ number_format($product->harga_beli) }}</span>
                          </td>
                          <td>
                            <span class="light-td mb-1">Keuntungan</span>
                            <span class="bold-td">Rp. {{ number_format($product->harga - $product->harga_beli) }}</span>
                          </td>
                        </tr>
                        @endforeach
                      </table>
