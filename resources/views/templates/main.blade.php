...
<html lang="en">
  <head>
    ...
    <title>Toko Sugeng | Reservation</title>
      ...
      <nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-top justify-content-center">
          <a class="navbar-brand brand-logo" href="{{ url('/dashboard') }}">
            <h2 class="logo1" id="nama_toko">{{ $market->nama_toko }}</h2>
            {{-- <img src="{{ asset('icons/logo.png') }}" alt="logo" />  --}}
          </a>
          <a class="navbar-brand brand-logo-mini" href="{{ url('/dashboard') }}">
            <h3 class="logo-mini">
                @php
                $words = explode(' ', $market->nama_toko);
                $abbrev = '';
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" data-toggle="collapse" href="#kkelola_cust" aria-expanded="false" aria-controls="kkelola_cust">
                <span class="menu-title">Kelola customer</span>
                <i class="menu-arrow"></i>
              </a>
              <div class="collapse" id="kkelola_cust">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item">
                    <a class="nav-link" href="{{ url('/customer') }}">Daftar Customer</a>
                  </li>
                </ul>
              </div>
            </li>
            ...
            <li class="nav-item">
              <a class="nav-link" href="{{ url('/supir') }}">
                <span class="menu-title">Supir</span>
              </a>
            </li>
            <li class="nav-item">
        ...
        <div class="main-panel">
          ...
          <footer class="footer" id="footer-content">
            <div class="container-fluid clearfix">
              <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">Copyright © 2022 <a href="{{ $market->link }}" target="_blank">{{ $market->nama_toko }}</a>. Pembelanjaan.</span>
              {{-- <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center"><a href="https://fhahroulrozi-website.netlify.app/"> TOKOTOREN</a> --}}
              </span>
            </div>
          </footer>
        </div>
